...
const UpdateList = () => {
    ...
    return (
        <div>
      <h2 className="lg:text-2xl md:text-xl text-center font-bold">Update spot</h2>
      ...
      <form onSubmit={handleform} className="card-body">
        ...
        <input type="submit" className="lg:mt-4 md:mt-4 mt-2 btn btn-primary w-3/4 lg:ml-16" value="Update" />
        </div>
      </form>
